...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle type 1 - tree1
        img_obstacle1 = Image.open("images/tree1.png")
        self.obstacle1_object = ImageTk.PhotoImage(img_obstacle1)
        # Obstacle type 2 - pedestrian
        img_obstacle2 = Image.open("images/pedestrian.png")
        self.obstacle2_object = ImageTk.PhotoImage(img_obstacle2)
        # Obstacle type 3 - shop
        img_obstacle3 = Image.open("images/shop.png")
        ...
        # Obstacle type 5 - road_closed1
        img_obstacle5 = Image.open("images/road_closed1.png")
        ...
        # Obstacle type 11 - building2
        img_obstacle11 = Image.open("images/building2.png")
        ...
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(0, pixels * 2, anchor='nw', image=self.obstacle11_object)
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(pixels, 0, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 3, pixels * 2, anchor='nw', image=self.obstacle9_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 4, 0, anchor='nw', image=self.obstacle12_object)
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 5, pixels * 3, anchor='nw', image=self.obstacle1_object)
        # Obstacle 7
        ...
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(0, pixels * 8, anchor='nw', image=self.obstacle5_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 8, pixels * 8 , anchor='nw', image=self.obstacle2_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 7, pixels * 8, anchor='nw', image=self.obstacle12_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 8, pixels * 4, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(0, pixels * 0, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 7, pixels * 7, anchor='nw', image=self.obstacle3_object)
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels, pixels * 6, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 1, pixels * 3, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 6, anchor='nw', image=self.obstacle6_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw', image=self.obstacle3_object)
        ...
        self.agent = self.canvas_widget.create_image(pixels * 2, pixels * 2, anchor='nw', image=self.robot)
